...
export default function Chessboard({playMove, pieces, isFlipped} : Props) {
...
const rows = isFlipped
  ? [...VERTICAL_AXIS.keys()]
  : [...VERTICAL_AXIS.keys()].reverse();

const cols = isFlipped
  ? [...HORIZONTAL_AXIS.keys()].reverse()
  : [...HORIZONTAL_AXIS.keys()];
...
for (let j of rows) {
  for (let i of cols) {
      ...
      console.log("Image for", piece, "is", image);
